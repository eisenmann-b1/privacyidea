        ...
        function (Idle, $scope, $sce, $http, $location,
            ...
            $scope.authenticate = function () {
                ...
                $http.post(authUrl, {
                    ...
                    if (data.result.value && data.result.value.token) {
                        ...
                        const multi_challenge = data.detail.multi_challenge;
                        ...
                        for (let i = 0; i < multi_challenge.length; i++) {
                            if (multi_challenge.length > 1) {
                    ...
                    if ($state.current.name === "response") {
                        ...
                        const errmsg = gettextCatalog.getString("Authentication failed.");
            ...
            $scope.do_login_stuff = function (data) {
                ...
                if ($scope.loggedInUser.role === "admin") {
                    ...
                    */
                    ConfigFactory.getRealms(function (data) {
                        ...
                        // Auto Create Dialog
                        const number_of_realms = Object.keys(data.result.value).length;
                ...
                if ($scope.unlocking) {
                    ...
                    // if we log in anew, we either go to the token or to the dashboard
