...
export const tokenTypes: TokenType[] = [
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "The TOTP token is a time based token. With a smartphone app like the privacyIDEA Authenticator" +
      " you can turn your smartphone into an authentication device.",
    rollover: true
  } as TokenType,
  {
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "The mOTP token is a time based OTP token for mobile devices. You can have the server generate the secret" +
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "The SSH Key Token stores the public SSH Key in the server. This can be used to authenticate to a secure" +
      " shell.",
    rollover: true
  } as TokenType,
  {
    ...
    info: "",
    text:
      "The Yubikey Token is an USB device that emits an event based One Time Password. You can initialize the" +
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "The Yubico Cloud mode forwards the authentication request to the YubiCloud. The Yubikey needs to be " +
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "The 4 Eyes token will only authenticate if two or more users use their token in succession. You can" +
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "The DayPassword token is a time based password token with a larger time window. OTP values of this" +
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "The indexed secret Token is based on a shared secret between privacyIDEA and the user. During " +
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "The Paper token will let you print a list of OTP values. In contrast to the TAN token, the OTP values" +
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "The PUSH token works with the privacyIDEA Authenticator App. It will send an authentication request to" +
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "The Questionnaire token will let you define answers to questions. When authenticating with this type of " +
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "The registration token is a code, that the user can use to authenticate once. Then the token is deleted" +
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "The TAN token will let you print a list of OTP values. In contrast to the Paper token, the OTP values can" +
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "The TiQR token is a Smartphone App token, which allows easy authentication by just scanning a QR Code " +
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "The U2F token is a token defined by the Fido Alliance. It is the predecessor to WebAuthn/Passkey, " +
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "A WebAuthn token is a phishing-resistant credential that uses public-key cryptography to prove your " +
  ...
  } as TokenType,
  {
    ...
    info: "",
    text:
      "A passkey is a phishing-resistant credential that uses public-key cryptography to prove your identity " +
